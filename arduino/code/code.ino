...
void setup() {
  ...
  wifiManager.autoConnect("IOT GAS MONITOR");
...
void loop(){
  ...
  gasValue = digitalRead(inputGas);
  Serial.println(gasValue);

  // Read GPIO 4 and print it on Serial port
  Serial.print("State of GPIO 4 / inputLight: ");
